...
table_list = ["comtradehs"+str(i) for i in range(1995,2014)]


q = "SELECT DISTINCT commodity_code from comtradehs1996"
...
FROM comtradehs1996 as t1, comtradehs1996 as t2
