...
def conversion_factors(table,engine):
	...
	query = """INSERT INTO conversion_factors (commodity, commodity_code, reporter_code,
	partner_code, year, classification,
	trade_flow1, trade_flow2 ,quantity_unit1 ,
	quantity_unit2, quantity1, quantity2, kg_per_unit)
	SELECT t1.`commodity`, t1.commodity_code, t1.`reporter_code`,
	t2.reporter_code, t1.year, t1.classification,
	t1.`trade_flow` as tf1, t2.trade_flow as tf2,
	t1.qty_unit, t2.qty_unit,t1.quantity as q1,
	t2.quantity as q2, t1.quantity/t2.quantity as ratio
